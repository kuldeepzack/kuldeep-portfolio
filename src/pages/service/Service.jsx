...
◦ Implemented optimized pagination and search features to enhance overall user experience and performance.`,
...

    {
        color: 'Purple',
        icon: 'bi-people',
        title: 'Rota Management System – Healthcare Workforce Portal',
        description: `◦ Developed a SaaS-based healthcare workforce portal for managing clients, care workers, and agency operations.
...
◦ Maintained real-time care worker schedule tracking and service monitoring for operational oversight.`,
...

    {
        color: 'Teal',
        icon: 'bi-briefcase',
        title: 'FindSoll – Job Freelance Marketplace Platform',
        description: `◦ Developed a multi-role SaaS platform for agencies, suppliers, clients, and freelancers with role-based access control.
